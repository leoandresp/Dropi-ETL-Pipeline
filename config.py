...
LIST_RAW_WALLET_NULL_VALIDATION =["ID","ingestion_id","ingestion_timestamp","row_number"]
LIST_RAW_DEVOLUTION_NULL_VALIDATION =["ID","NUMERO DE GUIA","ingestion_id","ingestion_timestamp","row_number"]

LIST_ORDER_NULL_VALIDATION = ["ID"]
LIST_ORDER_PRODUCT_NULL_VALIDATION = ["ID","ID_ORDER_PRODUCT"]
LIST_WARRANTY_NULL_VALIDATION = ["ID GARANTIA","ID ORDEN", "GUIA ORIGINAL"]
LIST_WALLET_NULL_VALIDATION = ["ID"]
LIST_DEVOLUTION_NULL_VALIDATION = ["ID","NUMERO DE GUIA"]

#Lista de Validación Numerica
LIST_ORDER_NUMBER_VALIDATION = ["TOTAL DE LA ORDEN", "GANANCIA", "PRECIO FLETE", "COSTO DEVOLUCION FLETE"]
LIST_ORDER_PRODUCT_NUMBER_VALIDATION = ["TOTAL DE LA ORDEN", "GANANCIA", "PRECIO FLETE", "COSTO DEVOLUCION FLETE",         
                                            "COMISION", "% COMISION DE LA PLATAFORMA", "PRECIO PROVEEDOR", "PRECIO PROVEEDOR X CANTIDAD"]
LIST_WALLET_NUMBER_VALIDATION = ["MONTO","MONTO PREVIO"]
LIST_GENERAL_SALES_NUMBER_VALIDATION = ["TOTAL DE LA ORDEN", "PRECIO FLETE", "PRECIO PROVEEDOR", "COSTO DEL PRODUCTO", 
